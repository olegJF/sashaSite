...
SECRET_KEY = '9x=g(b8g22_hjnnl5cu!7j_d%uc&_=&3_h_+!kryl0w3uro5z1'
...
#'APP_DIRS': False - ищет темплейты в myfirst\templates
#'APP_DIRS': True - ищет темплейты в папках,
# которые находятся в установленных приложениях (myfirst\core\templates\core)
TEMPLATES = [
    {
